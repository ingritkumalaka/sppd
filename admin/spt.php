...
//Konfigurasi Halaman
$_halaman_judul_tab = 'SPT';
$_halaman_judul_halaman = 'SPT';
$_halaman_judul_card = 'DATA SURAT PERINTAH TUGAS';
$_halaman_footer_card = 'SURAT PERINTAH TUGAS';

$_button_tambah_cap = 'Tambah Data SPT';

$_nama_file_form = 'spt_form.php';
...
$sql_tabel = "SELECT * FROM spt"; //produk merupakan nama tabel
        ...
        <div class="card">
          <div class="card-header">
            ...
            <div class="float-right">
              <button class="btn btn-success" data-toggle="modal" data-target="#modal-form" onclick="aksi('spt_form.php','tambah',null);"><?php echo $_button_tambah_cap;?></button>
            </div>
          </div>
          <div class="card-body">
            <!-- ISI KONTEN -->
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td><?php echo $data_tabel['tahun']; ?></td>
                    ...
                    <td><?php echo $data_tabel['transportasi']; ?></td>
                    <td><?php echo $data_tabel['berangkat']; ?></td>
                    <td><?php echo $data_tabel['sampai']; ?></td>
                    ...
                    <!--AKHIR KHUSUS FILE-->
                    <td><?php echo $data_tabel['post']; ?></td>
