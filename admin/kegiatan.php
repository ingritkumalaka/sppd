...
//Konfigurasi Halaman
$_halaman_judul_tab = 'KEGIATAN';
$_halaman_judul_halaman = 'KEGIATAN';
$_halaman_judul_card = 'DATA KEGIATAN YANG DILAKUKAN SELAMA PERJALANAN DINAS';
$_halaman_footer_card = 'KEGIATAN';

$_button_tambah_cap = 'Tambah Data Kegiatan';

$_nama_file_form = 'kegiatan_form.php';
...
$sql_tabel = "SELECT * FROM kegiatan"; //kegiatan merupakan nama tabel
        ...
        <div class="card">
          <div class="card-header">
            ...
            <div class="float-right">
              <button class="btn btn-success" data-toggle="modal" data-target="#modal-form" onclick="aksi('kegiatan_form.php','tambah',null);"><?php echo $_button_tambah_cap;?></button>
            </div>
          </div>
          <div class="card-body">
            <!-- ISI KONTEN -->
